...
export default function UpdateProductForm({ product }: Props) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    fd.append('name', name);
    fd.append('price', String(price)); // since formData only allows string, file, blob the price is converted tp string but the backend will handle the correct types
